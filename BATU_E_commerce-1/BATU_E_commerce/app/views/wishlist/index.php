                ...
                <div class="col">
                    <div class="card h-100 product-card position-relative">
                        ...
                        <?php if ($item['image_url']): ?>
                            <img src="/BATU_E_commerce/public/images/<?= htmlspecialchars($item['image_url']) ?>" class="card-img-top object-fit-contain" alt="<?= htmlspecialchars($item['name']) ?>">
                        <?php else: ?>
                            <img src="/BATU_E_commerce/public/images/no-image.jpg" class="card-img-top object-fit-contain" alt="No image available">
                        <?php endif; ?>
