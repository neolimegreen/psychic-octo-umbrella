...
<div class="container">
    ...
    <div class="row py-5">
        ...
        <div class="col-md-6">
            <img src="/BATU_E_commerce/public/img/hero-image.jpg" alt="Shopping" class="img-fluid rounded shadow-sm" onerror="this.src='/BATU_E_commerce/public/img/no-image.jpg'">
        </div>
    </div>
                    ...
                    <div class="col">
                        <div class="card h-100 product-card position-relative">
                            ...
                            <?php if ($product['image_url']): ?>
                                <img src="/BATU_E_commerce/public/uploads/<?= htmlspecialchars($product['image_url']) ?>" class="card-img-top" alt="<?= htmlspecialchars($product['name']) ?>">
                            <?php else: ?>
