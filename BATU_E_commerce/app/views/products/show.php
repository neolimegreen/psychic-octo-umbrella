            ...
            <div class="col-md-5">
                <div class="card position-relative">
                    ...
                    <?php if ($product['image_url']): ?>
                        <img src="/BATU_E_commerce/public/uploads/<?= htmlspecialchars($product['image_url']) ?>" class="card-img-top img-fluid" alt="<?= htmlspecialchars($product['name']) ?>">
                    <?php else: ?>
                        <img src="/BATU_E_commerce/public/img/no-image.jpg" class="card-img-top img-fluid" alt="No image available">
                    <?php endif; ?>
                </div>
            </div>
